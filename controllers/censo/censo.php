...
\k1lib\session\session_db::is_logged(TRUE, APP_URL . 'digitacion/log/form/');
...
DOM::menu_left()->set_active('nav-censo-log');

$db_table_to_use = "view_censo_logs";
$controller_name = "Registro de consultas del Censo";
...
$controller_object->set_config_from_class('\k1app\table_config_admin_default_class');
