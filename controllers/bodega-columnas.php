...
if ($controller_object->on_board_read()) {
    ...
    $related_div = $controller_object->board_read_object->create_related_list($related_db_table, NULL, "Filas", warehouse_columns_row_config::ROOT_URL, warehouse_columns_row_config::BOARD_CREATE_URL, warehouse_columns_row_config::BOARD_READ_URL, warehouse_columns_row_config::BOARD_LIST_URL, TRUE);
