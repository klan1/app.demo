...
DOM::menu_left_tail()->set_active('nav-cp-frontend-pages');

$db_table_to_use = "pages";
$controller_name = "Front end pages";
...
$controller_object->set_config_from_class('\k1app\pages_config');
