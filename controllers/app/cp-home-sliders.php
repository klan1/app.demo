...
DOM::menu_left_tail()->set_active('nav-cp-home-sliders');

$db_table_to_use = "home_slider";
$controller_name = "Home Slides";
...
$controller_object->set_config_from_class('\k1app\home_slides_config');
