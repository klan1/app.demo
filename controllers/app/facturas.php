...
DOM::menu_left()->set_active('nav-invoice');

$db_table_to_use = "invoice";
$controller_name = "Factura";
...
$controller_object->set_config_from_class("\k1app\invoice_config");
//
///**
...
if ($controller_object->on_object_read()) {
    ...
    // purchase_order LINK
    $purchase_order_url = url::do_url(APP_BASE_URL . purchase_order_config::ROOT_URL . '/' . purchase_order_config::BOARD_READ_URL . '/--customfieldvalue--/', $get_params);
    $controller_object->object_read()->apply_link_on_field_filter($purchase_order_url, ['purchase_order_id'], ['purchase_order_id']);
}
