...
\k1lib\session\session_db::is_logged(TRUE, APP_URL);
...
DOM::menu_left()->set_active('nav-admin-candidatos');

$db_table_to_use = "reg_candidatos";
$controller_name = "Candidatos Nacional - Octubre 27 - 2019";

/**
 * ONE LINE config: less codign, more party time!
 */
$controller_object = new \k1lib\crudlexs\controller_base(APP_BASE_URL, $db_sie, $db_table_to_use, $controller_name, 'k1lib-title-3');
$controller_object->set_config_from_class('\k1app\table_config_reg_candidatos');
...
//     * Related list
//     */
//    $related_db_table = new \k1lib\crudlexs\class_db_table($db_sie, "related_table_name");
