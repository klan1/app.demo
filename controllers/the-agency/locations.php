...
DOM::menu_left()->set_active('nav-agency-locations');

/**
 * ONE LINE config: less codign, more party time!
 */
$controller_object = new \k1lib\crudlexs\controller_base(APP_BASE_URL, $db, "locations", "Agency locations", 'k1lib-title-3');
