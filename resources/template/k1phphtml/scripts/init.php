...
$body->append_child_tail(new script(BOWER_PACKAGES_URL . "foundation-datepicker/js/foundation-datepicker.min.js"));
if (K1LIB_LANG != 'en') {
    $body->append_child_tail(new script(BOWER_PACKAGES_URL . "foundation-datepicker/js/locales/foundation-datepicker." . K1LIB_LANG . ".js"));
}
