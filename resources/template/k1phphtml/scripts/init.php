...
$head->link_css(APP_TEMPLATE_URL . "css/k1-app.css?time=" . mktime());
$head->link_css(APP_TEMPLATE_URL . "css/custom-styles.css?time=" . mktime());
...
$body->append_child_tail(new script(APP_TEMPLATE_URL . "js/k1app.js?time=" . mktime()));
$body->append_child_tail(new script(APP_TEMPLATE_URL . "js/custom-scripts.js?time=" . mktime()));
