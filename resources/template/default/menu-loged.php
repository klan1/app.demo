...
<?php endif ?>
<li>
    <a href="<?php echo url::do_url(APP_URL . "php-file-viewer/?file=") ?><?php temply::set_template_place("php-file-to-show") ?>" target="php-viewer" class="button warning">View PHP Code</a>
</li>
