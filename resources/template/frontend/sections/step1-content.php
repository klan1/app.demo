...
if (!empty($ecard_data)) :
    ...
    $user_message->set_value($custom_data['send_message12 '] == $default_message ? '' : $custom_data['send_message']);
    // FONT
    ...
    foreach ($ecard_fonts as $font_file => $font_name) {
        ...
        if (!$font_selected && (($font_name == $post_data['font']) || ($font_name == $ecard_fonts[$ecard_data['ecard_font']]))) {
            if (!$font_selected) {
    ...
    $ecard->set_quality(45);
    ?>
    <!-- <?php echo basename(__FILE__) ?> -->
    <div class="slide-inner">
        <ul class="steps clearfix">
            <li class="selected"><a href="./"><span>Step 01</span>Write your message</a></li>
            <li><a href="../step2/"><span>Step 02</span>Make someone happy</a></li>
            <li><a href="../step3/"><span>Step 03</span>Send your love</a></li>
        </ul>
    </div>    
    <div class="inner-content">
        <div class="container">
            ...
            <form id="ecard-customizer" class="eebunny-form clearfix" method="post">
                <div class="col1">
