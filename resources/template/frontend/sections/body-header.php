...
namespace k1app ?>
<?php
// d(\k1lib\session\session_db::get_user_data()) 
?>
<?php
global $search_query, $search_input;
?>
...
<header class="site-header">
    <div class="container clearfix">
        ...
        <div class="right">
            <div class="searchbox">
                <form class="searchform" method="get" action="<?php echo APP_URL . 'site/category/all/' ?>">
                    <?php echo $search_input ?>
                    <input type="image" id="search-btn" name='' src="<?php echo APP_TEMPLATE_IMAGES_URL; ?>/lupa.png" alt="search"/>
                </form>
            </div>
            <div class="login-box">
