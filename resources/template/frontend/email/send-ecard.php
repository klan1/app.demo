<html>
    <head>
        <title>Your EeBunny eCard</title>
    </head>
            ...
            <tr>
                <td>
                    <table id="header-title"  width="600" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding: 5px 0; text-align: center;"><a href="#" style="color: #a5576b; font-family: Arial; font-size:10px;  line-height: 1; margin:0; padding:0;">View as webpage</a></td>
                        </tr>
                    ...
                    <table id="main-content" width="600" style="background:#ce7082;" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <h2 style="color:#fff;font-family:Lucida handwriting;font-size:38px;line-height:1;margin:20px 0 10px;padding:0;text-shadow: 2px 2px 1px #663849;">Hi Erika Bautista,</h2>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <h3 style="color: #fff; text-shadow: 2px 2px 1px #663849; font-family:Arial; font-size:22px;"><span style="color:#fbd5e3;">Natalia Barco</span> sent you a EeBunny eCard</h3>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <img src="<?php echo APP_TEMPLATE_URL?>email/img/icon-ecard.png" width="294" height="231" alt="ecard" style="display:inline-block;height:auto;max-width:100%"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <a href="#" style="margin-bottom: 18px;display: inline-block;"><img src="<?php echo APP_TEMPLATE_URL?>email/img/download-ecard.png" width="215" height="56" alt="Download eCard"/></a>
                            </td>
                        </tr>
                        <tr>
